...
/* harmony export */ });
/* harmony import */ var _Table__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/* harmony import */ var _Wall__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
/* harmony import */ var _Box__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
...
class Utils {
    ...
    constructor(livingRoom,roomTag){
        ...
        this.utilGet = null
        this.rect = null
        this.utilsBox = new _Box__WEBPACK_IMPORTED_MODULE_2__.Box(900,250,[]);
    ...
    generateUtils(){
        ...
        const walls = [new _Wall__WEBPACK_IMPORTED_MODULE_1__.Wall(-1,[30,60],[15,150]),new _Wall__WEBPACK_IMPORTED_MODULE_1__.Wall(-1,[70,135],[15,75]), new _Wall__WEBPACK_IMPORTED_MODULE_1__.Wall(-1,[180,120],[150,15]),new _Wall__WEBPACK_IMPORTED_MODULE_1__.Wall(-1,[180,160],[75,15])]
        walls.forEach(w => this.utilsBox.addElement(w))

        const tables = [new _Table__WEBPACK_IMPORTED_MODULE_0__.Table(0,-1,[480,90],[100,100]),new _Table__WEBPACK_IMPORTED_MODULE_0__.Table(0,-1,[600,140],[50,50]),new _Table__WEBPACK_IMPORTED_MODULE_0__.Table(0,-1,[720,140],[100,100],""),new _Table__WEBPACK_IMPORTED_MODULE_0__.Table(0,-1,[810,165],[50,50],"")]
...
class Table {
    ...
    clone(){
        return lodash__WEBPACK_IMPORTED_MODULE_0___default().cloneDeep(this)
    }
}
...
/* harmony export */ });
/* harmony import */ var _Box__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
/* harmony import */ var _Table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var _Wall__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
class Room {
    ...
    constructor(api){
        this.api = api;
        this.room = new _Box__WEBPACK_IMPORTED_MODULE_0__.Box(900, 600,[])
    ...
    async getTables(){
        this.api.setUrl(new _Table__WEBPACK_IMPORTED_MODULE_1__.Table().url)
        const tables = await this.api.list()
        tables.results.forEach(t => {
            this.addElement(new _Table__WEBPACK_IMPORTED_MODULE_1__.Table(parseInt(t.id),parseInt(t.number),[parseInt(t.position_x),parseInt(t.position_y)],[parseInt(t.size),parseInt(t.size)],t.format),false,false)
            this.nbTables++
        })
    }

    async getWalls(){
        this.api.setUrl(new _Wall__WEBPACK_IMPORTED_MODULE_2__.Wall().url)
        const walls = await this.api.list()
        walls.results.forEach(t => {
            this.addElement(new _Wall__WEBPACK_IMPORTED_MODULE_2__.Wall(parseInt(t.id),[parseInt(t.position_x),parseInt(t.position_y)],[parseInt(t.width),parseInt(t.height)]),false,false)
        })
    }
...
/* harmony import */ var _Room__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
